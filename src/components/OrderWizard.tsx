        ...
        return (
          <div className="space-y-8 step-reveal">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="relative aspect-square rounded-[3rem] overflow-hidden bg-bg dark:bg-black/20 border border-border flex items-center justify-center">
      ...
      case 7:
        return (
          <div className="space-y-8 step-reveal">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4 p-1 bg-bg dark:bg-black/20 rounded-2xl border border-border">
                  <button
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-6 py-4 rounded-2xl bg-bg dark:bg-black/20 border border-border focus:border-primary outline-none transition-all"
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-2 animate-fade-in">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full pl-12 pr-6 py-4 rounded-2xl bg-bg dark:bg-black/20 border border-border focus:border-primary outline-none transition-all resize-none"
                      />
                    </div>
                  </div>
                )}
